package com.mobelite.corelibkmm.src.repository


import Utils
import com.mobelite.corelibkmm.src.data.local.manager.DataManager
import com.mobelite.corelibkmm.src.data.remote.repository.Repository
...
import com.mobelite.corelibkmm.src.utils.Constants.ACTION_REGISTER
...
class UserRepository(private val context: Any?) {
    ...
    suspend fun updateData(): ResponseWS {
        return Repository(context).getUpdateDeviceInfo(
            action = "mpUpdateDeviceInformation",
